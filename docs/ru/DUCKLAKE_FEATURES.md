...
DuckLake записывает абсолютные пути к Parquet-файлам в PostgreSQL-каталог в момент создания таблицы. Если таблица создана с `rustfs:9000`, то все файлы будут доступны только через этот хост. Смена hostname = полное пересоздание таблиц.
